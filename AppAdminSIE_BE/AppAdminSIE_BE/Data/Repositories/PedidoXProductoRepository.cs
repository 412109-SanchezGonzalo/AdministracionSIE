    ...
    public class PedidoXProductoRepository : IPedidoXProductoRepository
    {
        ...
        public IEnumerable<PedidoXProducto> GetAllPedidoXProductosSinFacturar()
        {
            ...
            using (var cmd = new MySqlCommand(@"
                                    ...
                                    JOIN Edificio e ON pxp.id_edificio = e.id_edificio 
                                    WHERE ped.Estado = 'Entregado' OR 
                                    ped.Estado = 'Pendiente'", conn))
            {
                conn.Open();
        ...
        public IEnumerable<PedidoXProducto> GetAllPedidoXProductosPorFecha(DateTime fecha)
        {
            ...
            using (var cmd = new MySqlCommand(@"
                                    ...
                                    JOIN Productos pro ON pxp.producto_id = pro.id 
                                    JOIN Edificio e ON pxp.id_edificio = e.id_edificio 
                                    WHERE ped.FechaEntrega = @fecha", conn))
            {
