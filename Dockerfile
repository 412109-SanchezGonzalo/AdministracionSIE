...
COPY AppAdmSIE_BE/*.csproj ./AppAdmSIE_BE/
COPY AppAdmSIE_FE/*.csproj ./AppAdmSIE_FE/

# Restaura las dependencias
WORKDIR /app/AppAdmSIE_BE
RUN dotnet restore
